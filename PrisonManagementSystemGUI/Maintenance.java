...
public class Maintenance {
    ...
    public Maintenance(IDandPasswords idandPasswords) throws ClassNotFoundException {
        frameMa = new JFrame("Prison Management System - Maintenance Workers");
        frameMa.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frameMa.setExtendedState(JFrame.MAXIMIZED_BOTH);
        ImageIcon icon1 = new ImageIcon("images/For_Project/Icon2.jpeg");
        frameMa.setIconImage(icon1.getImage());

        // Left Panel for Options
        JPanel leftPanel = new JPanel();
        leftPanel.setLayout(new BoxLayout(leftPanel, BoxLayout.Y_AXIS));
        leftPanel.setPreferredSize(new Dimension(200, frameMa.getHeight()));
        ...
        JButton backButtonMa = new JButton("Back");
        ...
        backButtonMa.addActionListener(new ActionListener() {
            @Override
        ...
        // Main Layout
        frameMa.setLayout(new BorderLayout());
        frameMa.add(leftPanel, BorderLayout.WEST);
        frameMa.add(rightPanel, BorderLayout.CENTER);
    ...
    private JTable createTable(String query, String[] columnNames) {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/prison_management_system", "root", "24mebredbms36");
            ...
            JOptionPane.showMessageDialog(frameMa, "Database error: " + ex.getMessage(),
