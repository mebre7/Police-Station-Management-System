...
public class Guards {
    private JFrame frameGa;
    private JPanel rightPanel;
    private CardLayout cardLayout;

    public Guards(IDandPasswords idandPasswords) throws ClassNotFoundException {
        frameGa = new JFrame("Prison Management System - Guards");
        frameGa.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frameGa.setExtendedState(JFrame.MAXIMIZED_BOTH);
        ImageIcon icon1 = new ImageIcon("images/For_Project/Icon2.jpeg");
        frameGa.setIconImage(icon1.getImage());

        // Left Panel for Options
        JPanel leftPanel = new JPanel();
        leftPanel.setLayout(new BoxLayout(leftPanel, BoxLayout.Y_AXIS));
        leftPanel.setPreferredSize(new Dimension(200, frameGa.getHeight()));
        ...
        JButton backButtonGa = new JButton("Back");
        JButton exitButtonGa = new JButton("Exit");
        ...
        backButtonGa.addActionListener(new ActionListener() {
            @Override
        ...
        exitButtonGa.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.exit(0);
            }
        ...
        leftPanel.add(backButtonGa);
        leftPanel.add(exitButtonGa);
        ...
        // Main Layout
        frameGa.setLayout(new BorderLayout());
        frameGa.add(leftPanel, BorderLayout.WEST);
        frameGa.add(rightPanel, BorderLayout.CENTER);

        frameGa.setVisible(true);
    }
    ...
    private JTable createTable(String query, String[] columnNames) {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/prison_management_system", "root", "24mebredbms36");
            ...
            JOptionPane.showMessageDialog(frameGa, "Database error: " + ex.getMessage(),
